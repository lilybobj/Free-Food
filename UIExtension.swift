...
enum Nobile: String {
    case regular = "Pokemon Solid"
    case medium = "Nobile-Medium"
    case semibold = "Nobile-BoldItalic"
    case bold = "Nobile-Bold"
}

extension Font {
    
    static func customfont(_ font: Nobile, fontSize: CGFloat) -> Font {
...
extension Color {
    ...
    static var primaryApp: Color {
        return Color(hex: "F7890D")
    }
    
    static var primaryText: Color {
        return Color(hex: "0E0546")
    }
    
    static var secondaryText: Color {
        return Color(hex: "061371")
    }
    
    static var textTitle: Color {
        return Color(hex: "02082A")
    }
    
    static var placeholder: Color {
        return Color(hex: "9EC2CA")
    }
    
    static var darkGray: Color {
        return Color(hex: "37555C")
    }
